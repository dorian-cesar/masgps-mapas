...
const connect = () => {
  ...
  ws.value.onopen = (event) => {
    ...
    ws.value.send('{"action":"subscribe","hash":"a42aea049190363eb6e21ecc954600b6","events":["state"],"trackers":[10176440]}');
  };
...
//AIzaSyAfLNIHZHdf9ZDKnEP9z3M-lK9C-ryRodU
  ...
  >
    ...
    <CustomMarker :options="{ position: positionBus, anchorPoint: 'BOTTOM_CENTER' }">
      ...
      <div style="width: 30px; height: 30px;">
        <span style="background-color: aqua;">MiBus </span>
        <span style="background-color: aqua;">LGJW17</span>
